    ...
    content:
      ...
      text: |-
        **Nonparametric Test in Copula Modeling**
        ...
        [1] Guanjie Lyu, Mohamed Belalia∗. (2024). Testing independence using C-power functions. <span style="color: #21ABCD;"> Under review </span>

        [2] Guanjie Lyu, Mohamed Belalia∗. (2024). Testing equality between the dependence structures of two samples using Bernstein polynomials. arXiv:2303.02510. <span style="color: #21ABCD;"> Under revision </span>
